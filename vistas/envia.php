...
//To address and name
$mail->addAddress("info@comercializadorahous.com");



$mail->isHTML(true);

$mail->Subject = "Cotización COMERCIALIZADORA DE PRODUCTOS ELECTRICOS HOUS";
$mail->Body = "
              <!DOCTYPE html>
                <html>
                <head>
                <title>COMERCIALIZADORA DE PRODUCTOS ELECTRICOS HOUS</title>
                </head>
                <body  style='border:.5px solid rgba('0,0,0,0.8');background:#fff'>
                <h1 style='text-align:center;  font-weight: bold'> COMERCIALIZADORA DE PRODUCTOS ELECTRICOS HOUS</h1>
